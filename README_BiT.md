## My radically altered Big Transfer package to deal with multi-label datasets for pretraining feature extractors
See https://github.com/Kameradna/granular-tags for details on the larger project, this is just utilising the subfolder for visual encoder pretraining, and differs from the project version since this includes specific extra features for inclusion in this project, R2Gen-fulltrans.
